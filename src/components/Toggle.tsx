...
const ToggleButton = styled.span<ToggleStyleProps>(({ active }) => [
  tw`relative inline-flex flex-shrink-0 cursor-pointer transition-colors ease-in-out duration-200 border-2 border-transparent focus:ring-2 focus:ring-gray-400 focus:outline-none focus:ring-opacity-50`,
  !active && tw`bg-gray-300 rounded-full`,
  active && tw`bg-gray-700 rounded-full`,
]);
