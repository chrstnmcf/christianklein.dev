...
export default function Excerpt({ meta }: Props) {
  ...
  return (
    <Link href={`/posts/${slug}`}>
      <a>
        <div tw="flex flex-col h-full rounded-md py-4 px-5 border border-gray-200 transition duration-500 dark:border-gray-700 hover:(text-gray-700 border-white dark:text-gray-300 dark:border-gray-800 shadow-light dark:shadow-dark dark:bg-gray-800)">
