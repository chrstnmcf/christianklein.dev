...
Next.js and Gatsby and both would be suitable for building a site like this, you could even argue that Gatsby would be
...
can start with a minimal setup but it also can scale up easily at a later stage without rewriting your whole
application. Cool, right? And let's be honest, since the whole purpose of building this site was to have fun building
...
To sum it up, this is the tech stack that I used for building [christianklein.dev](https://christianklein.dev/).
